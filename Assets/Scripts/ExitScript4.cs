...
public class ExitScript4 : MonoBehaviour
{
    ...
    void Update()
    {
        if (GameManagerScript.Instance.Key && GameManagerScript.Instance.Level == 4)
        {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            exitWalls = Instantiate((GameObject)Resources.Load("Prefabs/ExitWalls4"));
